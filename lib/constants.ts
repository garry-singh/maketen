export const SITE_URL = "https://maketen.vercel.app";

export const SOCIAL_LINKS = {
  /** Handle used for the "via @..." attribution on shared posts */
  twitterHandle: "MakeTenGame",
};
...
export const MAKE_X_STORAGE_KEYS = {
  ...
  REVEALED_DATE: "make_x_revealed_date",
  PLAYED_COUNT: "make_x_played_count",
  SOLVED_COUNT: "make_x_solved_count",
  BEST_TIME: "make_x_best_time",
};
...
export const MAKE_EXACT_OPS_STORAGE_KEYS = {
  ...
  REVEALED_DATE: "make_exact_ops_revealed_date",
  PLAYED_COUNT: "make_exact_ops_played_count",
  SOLVED_COUNT: "make_exact_ops_solved_count",
  BEST_TIME: "make_exact_ops_best_time",
};
